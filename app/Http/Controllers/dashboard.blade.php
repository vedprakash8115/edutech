                ...
                <a href="{{route('liveclass')}}">
                    <div class="card-body" >
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            ...
                            <img src="{{asset('public/assets/img/icons/live.gif')}}" alt="" srcset="" height="70" width="70">
                        </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="javascript:void(0)">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            ...
                            <img src="{{asset('public/assets/img/icons/content.gif')}}" alt="" srcset="" height="70" width="70">
                ...
                <a href="javascript:void(0)">
                    <div class="card-body">
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            ...
                            <img src="{{asset('public/assets/img/icons/user1.gif')}}" alt="" srcset="" height="70" width="70">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            ...
                            <div class="d-flex align-items-center icon-wrapper icon-wrapper-12">
                                <img src="{{asset('public/assets/img/icons/marketing.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        ...
                        <img src="{{asset('public/assets/img/icons/slider.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        ...
                        <img src="{{asset('public/assets/img/icons/books.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        ...
                        <img src="{{asset('public/assets/img/icons/website.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        ...
                        <img src="{{asset('public/assets/img/icons/user.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        ...
                        <img src="{{asset('public/assets/img/icons/test.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                      ...
                      <img src="{{asset('public/assets/img/icons/chat.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        ...
                        <img src="{{asset('public/assets/img/icons/report.gif')}}" alt="" srcset="" height="70" width="70">
            ...
            <div class="card-hover card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                        ...
                        <img src="{{asset('public/assets/img/icons/setting.gif')}}" alt="" srcset="" height="70" width="70">
