...
<div class="row">
            ...
            <a href="{{route('sliders.index')}}">
                    <div class="card-body" >
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">App sliders</h>
                                </div>
                                <div class="mt-sm-auto">
                                    <h5 class="mb-0">$84,686k</h5>
                                </div>
                ...
                <a href="{{ route('liveclass') }}">
                    <div class="card-body" >
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">Emails</h>
                                </div>
                                <div class="mt-sm-auto">
                                    <h5 class="mb-0">$84,686k</h5>
                                </div>
        ...
        <div class="col-12 col-md-8 col-lg-3 order-3 order-md-2 mt-3" title="SMS">
            <div class="card-hover card">
                <a href="{{route('liveclass')}}">
                    <div class="card-body" >
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">SMS</h>
                                </div>
                                <div class="mt-sm-auto">
                                    <h5 class="mb-0">$84,686k</h5>
                                </div>
        ...
        <div class="col-12 col-md-8 col-lg-3 order-3 order-md-2 mt-3" title="Whatsapp">
            <div class="card-hover card">
                <a href="{{route('liveclass')}}">
                    <div class="card-body" >
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">Whatsapp</h>
                                </div>
                                <div class="mt-sm-auto">
                                    <h5 class="mb-0">$84,686k</h5>
                                </div>
                ...
                <a href="{{route('coupons.index')}}">
                    <div class="card-body" >
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">Coupon code</h>
                                </div>
                                <div class="mt-sm-auto">
                                    <h5 class="mb-0">$84,686k</h5>
                                </div>
