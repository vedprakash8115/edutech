...
<body>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-6 text-center text-md-start">
          ...
          <a href="#discounts" class="btn btn-outline-light btn-lg">Browse courses</a>
        </div>
        <!-- Image Section -->
  ...
  <section class="stats-section py-4 bg-light">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-3">
          <i class="fas fa-user-graduate stat-icon" style="color: #bb5b5b"></i>
          <h3 class="stat-number">50,000+</h3>
          <p class="stat-label">Students</p>
        </div>
        <div class="col-md-3">
          <i class="fas fa-chalkboard-teacher stat-icon" style="color: #4854ae"></i>
          <h3 class="stat-number">1,500+</h3>
          <p class="stat-label">Teachers</p>
        </div>
        <div class="col-md-3">
          <i class="fas fa-user-tie stat-icon" style="color: rgb(136, 223, 37)"></i>
  ...
  <section id="popularCourses" class="py-5">
    <div class="container">
      ...
      <ul class="nav nav-pills mb-5 justify-content-center" id="courseTabs" role="tablist">

        @foreach ($categories as $index => $category)
      <li class="nav-item" role="presentation">
        <a class="nav-link {{ $index === 0 ? 'active' : '' }}" id="category-{{ $index }}-tab" data-bs-toggle="tab"
        href="#category-{{ $index }}" role="tab" aria-controls="category-{{ $index }}"
    ...
    @endforeach
      ...
      <div class="col-md-3 mb-4 py-4" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
        <div class="card fixed-height-card" data-href="{{ route('course.details', $video->id) }}"
        onclick="redirectToCourseDetails(this)">
        <img src="{{ asset($video->banner) }}" class="card-img-top" alt="{{ $video->course_name }}" />
        <div class="card-body">
        ...
        <p class="card-text fw-bold text-success">
          {{ isset($video->price) && $video->price > 0 ? '₹' . $video->price : 'Free' }}</p>
    ...
    @endforeach
      ...
      <a href="#more" class="btn btn-primary show-more">Show more <i class="fas fa-arrow-right"></i></a>
    </div>
  </section>
  ...
  <section id="industry-experts" class="py-5">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <!-- Card 1: Teacher 1 -->
        <div class="col-md-3 mb-4" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
          <div class="card h-100 text-center teacher-card">
            <img src="{{ asset('landing_ui/assets/imgs/teacher1.webp')}}"
              class="card-img-top rounded-circle mx-auto mt-4" alt="Teacher 1"
        ...
        <!-- Card 2: Teacher 2 -->
        <div class="col-md-3 mb-4" data-aos="fade-up" data-aos-duration="500" data-aos-delay="150">
          <div class="card h-100 text-center teacher-card">
            <img src="{{ asset('landing_ui/assets/imgs/teacher2.avif')}}"
              class="card-img-top rounded-circle mx-auto mt-4" alt="Teacher 2"
              style="width: 150px; height: 150px; object-fit: cover" />
            <div class="card-body">
        ...
        <!-- Card 3: Teacher 3 -->
        <div class="col-md-3 mb-4" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200">
          <div class="card h-100 text-center teacher-card">
            <img src="{{ asset('landing_ui/assets/imgs/teacher3.jpg')}}"
              class="card-img-top rounded-circle mx-auto mt-4" alt="Teacher 3"
              style="width: 150px; height: 150px; object-fit: cover" />
            <div class="card-body">
  ...
  <section class="news-section">
    <div class="news-container">
        ...
        <div class="scroll-buttons">
            <button class="scroll-button prev" id="scrollPrev">←</button>
            <button class="scroll-button next" id="scrollNext">→</button>
        </div>
            ...
            @foreach($news as $item)
                <article class="news-card">
                    <div class="news-image-container">
                        ...
                        @else
                            <img src="{{ asset('images/default-news.jpg') }}" alt="Default Image" class="news-image">
                        @endif
                    </div>
                    <div class="news-content">
                        <div class="news-date">{{ $item->date->format('F d, Y') }}</div>
                        <h3 class="news-title">{{ $item->title }}</h3>
                        <p class="news-description">{{ $item->description }}</p>
                        <a href="{{ route('news.show', $item->id) }}" class="read-more">Read More</a>
                    </div>
                </article>
            @endforeach
        </div>
  ...
  <section class="testimonial-section">
    <div class="container">
      ...
      <div class="testimonial-card" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
        ...
        <img src="{{ $testimonial->image ?? 'https://via.placeholder.com/80' }}"
          alt="{{ $testimonial->user->name }}" class="testimonial-image">
        </div>
      ...
      <div class="row g-4 flex-d justify-content-center">
        ...
        <div class="col-md-3">
          <div class="card resource-card">
            <div class="card-background" style="background: url('landing_ui/assets/imgs/videos.png') center/cover">
        ...
        <div class="col-md-3">
          <div class="card resource-card">
            <div class="card-background" style="background: url('landing_ui/assets/imgs/pdfs.webp') center/cover">
              <div class="card-hover-content">
      ...
      <div class="row">
        <div class="col-12">
          <ul class="list-inline">
            ...
            <a href="#" class="text-white">© 2024 CMP Techsseract LLP, Inc. All Rights Reserved</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateScrollButtons() {
        ...
        const isAtEnd = newsContainer.scrollLeft + newsContainer.clientWidth >= newsContainer.scrollWidth;
        
        scrollPrev.style.opacity = isAtStart ? '0.5' : '1';
        scrollPrev.style.cursor = isAtStart ? 'default' : 'pointer';
        scrollNext.style.opacity = isAtEnd ? '0.5' : '1';
        scrollNext.style.cursor = isAtEnd ? 'default' : 'pointer';
    }
    ...
    async function loadMoreNews() {
        ...
        const scrollPosition = newsContainer.scrollLeft + newsContainer.clientWidth;
    ...
    function createNewsCard(item) {
        ...
        return `
            <article class="news-card">
                ...
                <div class="news-content">
                    <div class="news-date">${new Date(item.date).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</div>
                    <h3 class="news-title">${item.title}</h3>
                    <p class="news-description">${item.description}</p>
    ...
    newsContainer.addEventListener('scroll', loadMoreNews);
});
</script>
  <script>
