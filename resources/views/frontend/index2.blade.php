                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    @if($graphic->logo)
                                        <img src="{{ asset('storage/'.$graphic->logo) }}" alt="Current Logo" class="mt-2" style="max-width: 100px;">
                                    @endif
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="preview-box mb-4 shadow-sm" id="top_bar_preview" style="position: relative; width: 100%; height: 200px; border: 1px solid #ccc; overflow: hidden;">
                                    <div id="preview_logo_container" style="position: absolute;">
                                        <img id="preview_logo" src="{{ asset('storage/'.$graphic->logo) }}" alt="Logo Preview" style="max-width: 150px; max-height: 150px;">
                                    </div>
