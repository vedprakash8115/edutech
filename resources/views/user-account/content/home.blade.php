...
<div class="" style="border-radius: 10px">
                ...
                @foreach($slider as $index => $slide)
                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}"
                        ...
                        <div class="carousel-caption d-md-block">
                            <h5
                                style="font-weight:100; font-family:Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif; font-size:160px;">
                                {{ $slide->title }}</h5>
                            <p
                                style="font-weight:100; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:30px;">
                                {{ $slide->description }}</p>
    ...
    <section id="featured" class="container-fluid">
        <h2 class="section-title ">
            ...
            <p class="text-dark " style="display: inline">Featured Courses</p>
        </h2>
                                                ...
                                                @else
                                                    ...
                                                    @if($course->discount_price)
                                                        <span class="discount-price">
                                                            <i class="fas fa-tags me-2"></i>Now at $<span class="typed-price"
                                                                data-price="{{ number_format($course->discount_price, 2) }}"></span>
                                                        </span>
                                                    @endif
                                                @endif
                                            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <p class="lead mb-5 animate__animated animate__fadeInUp">Empowering minds, shaping futures. We are
                    committed to providing world-class education and fostering innovation.</p>
            </div>
        </div>
